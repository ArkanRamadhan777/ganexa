    ...
    <div className="min-h-screen py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto mb-16">
          <div className="backdrop-blur-xl bg-white/5 border-2 border-hyperspeed-cyan/50 rounded-2xl p-10 text-center">
            ...
            {socialMedia.map((social, index) => {
              ...
              return (
                <a
                  ...
                  className={`backdrop-blur-xl bg-white/5 border border-gray-200/50 dark:border-gray-800/50 rounded-2xl p-8 text-center transition-all duration-300 transform hover:scale-105 ${social.hoverClass} group`}
                >
                  ...
                  <h3 className="text-xl font-heading font-bold mb-2 text-white">{social.name}</h3>
        ...
        <div className="text-center">
          <div className="backdrop-blur-xl bg-white/5 border-2 border-hyperspeed-pink/40 rounded-2xl p-8 max-w-3xl mx-auto">
