    ...
    <div className="min-h-screen py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-primary/10 to-blue-500/10 border border-primary/30 rounded-2xl p-10 max-w-3xl mx-auto">
        ...
        <div className="mt-16 mb-12">
          <h3 className="text-2xl font-heading font-bold text-center mb-8 text-gray-900 dark:text-white">
            Teknologi yang Kami Gunakan
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center max-w-4xl mx-auto">
            <div className="bg-white dark:bg-[#1a1d29] border border-gray-200 dark:border-gray-800 rounded-xl p-4">
              <div className="text-3xl mb-2">⚛️</div>
              <h4 className="font-heading font-bold text-sm text-gray-900 dark:text-white">React</h4>
              <p className="text-xs text-gray-600 dark:text-gray-400">Modern & Fast</p>
            </div>
            <div className="bg-white dark:bg-[#1a1d29] border border-gray-200 dark:border-gray-800 rounded-xl p-4">
              <div className="text-3xl mb-2">🎨</div>
              <h4 className="font-heading font-bold text-sm text-gray-900 dark:text-white">Tailwind CSS</h4>
              <p className="text-xs text-gray-600 dark:text-gray-400">Clean Design</p>
            </div>
            <div className="bg-white dark:bg-[#1a1d29] border border-gray-200 dark:border-gray-800 rounded-xl p-4">
              <div className="text-3xl mb-2">🗄️</div>
              <h4 className="font-heading font-bold text-sm text-gray-900 dark:text-white">Supabase</h4>
              <p className="text-xs text-gray-600 dark:text-gray-400">Database & Auth</p>
            </div>
            <div className="bg-white dark:bg-[#1a1d29] border border-gray-200 dark:border-gray-800 rounded-xl p-4">
              <div className="text-3xl mb-2">💎</div>
              <h4 className="font-heading font-bold text-sm text-gray-900 dark:text-white">Flowbite</h4>
              <p className="text-xs text-gray-600 dark:text-gray-400">UI Components</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center mb-16">
          ...
          <div className="bg-white dark:bg-[#1a1d29] border border-gray-200 dark:border-gray-800 rounded-xl p-6">
            <div className="text-3xl mb-3">🔄</div>
            <h4 className="font-heading font-bold mb-2 text-gray-900 dark:text-white">Bisa Upgrade</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">Sistem dapat di-upgrade ke paket lebih tinggi</p>
          </div>
          <div className="bg-white dark:bg-[#1a1d29] border border-gray-200 dark:border-gray-800 rounded-xl p-6">
            <div className="text-3xl mb-3">💰</div>
            <h4 className="font-heading font-bold mb-2 text-gray-900 dark:text-white">Harga Pelajar</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">Harga spesial ramah kantong untuk organisasi sekolah</p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/30 rounded-2xl p-8">
            <h3 className="text-xl font-heading font-bold mb-4 text-center text-gray-900 dark:text-white">
              📌 Ketentuan Tambahan
            </h3>
